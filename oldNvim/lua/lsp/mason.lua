  ...
  config = function()
    ...
    local on_attach = function(client, bufnr)
      if client.supports_method("textDocument/formatting") then
        ...
        vim.api.nvim_buf_create_user_command(bufnr,"LspFormatting", formatting_cb, {})
        vim.keymap.set("n", "<space>f", formatting_cb, { buffer = bufnr })
        -- vim.api.nvim_clear_autocmds({ group = augroupe buffer = bufnr })
      ...
      vim.api.nvim_set_option_value('omnifunc', 'v:lua.vim.lsp.omnifunc', { buf = bufnr }) -- Enable completion triggered by <c-x><c-o>
      ...
      eslint = {
        ...
        handlers = {
          ["window/showMessageRequest"] = function(_, result)
            ...
            return vim.lsp.handlers["window/showMessageRequest"](nil, result, _)
          end,
        },
      },
      html = {
